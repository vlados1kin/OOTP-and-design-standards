...
public class SquareFactory(double x, double y, double side) : Factory(x, y, side, side, Math.PI / 2)
{
    public override string TypeOfFactory() => "square";
    public override string NameOfFactory() => "Квадрат";
    ...
    {
        return new SquareFactory(X, Y, BottomSide);
    }
}